...
class ViewTypeTest {
    ...
    void getFXMLView() {
        ...
        Assertions.assertEquals("views/add-customer-view.fxml", ViewType.CREATE_CUSTOMER.getFXMLView());
        Assertions.assertEquals("views/workers-view.fxml", ViewType.WORKERS.getFXMLView());
        Assertions.assertEquals("views/create-document-view.fxml", ViewType.CREATE_DOCUMENT.getFXMLView());
        Assertions.assertEquals("views/add-worker-view.fxml", ViewType.CREATE_WORKER.getFXMLView());
